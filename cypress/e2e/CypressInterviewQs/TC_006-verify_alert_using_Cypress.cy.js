...
describe('verify the js alert',function(){
    ...
    it('TC_01-verify the JS alert "ok" button',function(){
        ...
        cy.get("button[onclick='jsAlert()']").click() // when clicking then trigger alert.
    ...
    it('TC_02- verify the JS confirm alert with Ok button',function(){
        ...
        cy.on("window:confirm",function(str){
            ...
            return true // for the ok button
        })
        cy.get('button[onclick="jsConfirm()"]').click() //// when clicking then trigger confirm alert.
        //assertion
